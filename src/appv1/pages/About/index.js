...
import { faSquare, faSquareFull, faCheck,faBullseye, faHandPointer } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <section className='about__section'>
            ...
            <article id="avantReconversion">
                ...
                <p>J'ai commencé par une formation universitaire en Droit, spécialisé droit public. J'ai adoré ma formation, les matières étaient passionnantes, mais je n'arrivais pas à me projeter dans un futur professionnel. J'ai fait une année en Erasmus, prendre le large, bon ok l'Espagne ce n'est pas si loin que ça! Cette année d'Erasmus m'a fait prendre en maturité et m'a permis d'éveiller une conscience écologique. A mon retour, c'était décidé, je suivrai un parcours droit environnement.</p>
                <p>J'ai suivi un master en Droit de l'Environnement à l'Université de Nantes. A l'issue de ce master, j'ai fait un service civique dans l'administration, pour la mise en place d'une collecte de déchets. Et paf,c'est le déclic je souhaitais travailler dans le domaine des déchets. J'ai rejoint l'équipe des Joyeux Recycleurs en tant que chargée de développement, les missions étaient très diverses : gestion d'une équipe de 13 collecteurs, gestion des plannings, responsable du suivi client. J'ai énormément appris durant cette expérience.</p><p>Souhaitant rester dans l'environnement, j'ai rejoint l'équipe de Economie d'Energie, une entreprise qui assure la gestion des Certificats d'Economie d'Energie pour ses clients.</p><p>J'ai exercé le métier assistante Grands Comptes, puis de Responsable Grand Comptes, cette expérience m'a permis d'être au cœur de l'entreprise et d'échanger régulièrement avec l'équipe projet, en charge de la gestion des plateformes web pour les bénéficiaires des Certificats d'Economie d'Energie.</p>
                <br/>
                <p>Cette expérience m'a aussi fait prendre conscience que malgré les responsabilités qui m'étaient confiées, je n'étais pas épanouie dans ce métier. J'avais besoin d'un métier autonome où je puisse être en contrôle de ce que je réalisais. J'ai engagé une réflexion sur ce que j'attendais d'un travail. J'avais besoin d'un métier où : </p>
                <ul>
                    <li><FontAwesomeIcon icon={faCheck} color="#9959f7"/>je peux être en <em>autonomie</em>,</li>
                    <li><FontAwesomeIcon icon={faCheck} color="#9959f7"/>j'ai la possibilité d'être en <em>apprentissage constant</em>,</li>
                    <li><FontAwesomeIcon icon={faCheck} color="#9959f7"/>un métier <em>créatif</em>,</li>
                    <li><FontAwesomeIcon icon={faCheck} color="#9959f7"/>un métier qui me permette dans un <em>temps raisonnable</em> de me reconvertir.</li>
                </ul>
            </article>
            <article id="paroursReconversion">
                <h3>💻 ⌨️ Mon parcours de reconversion ! </h3>
                <p>J'ai tout d'abord réalisé une formation sur 15 jours pour confirmer mon attrait pour ce nouveau métier que je découvrais. On a pu découvrir HTML, CSS et wordpress, le projet final était un projet où l'on devait refaire un site wordpress pour un auto-entrepreneur, ça a vraiment été le déclic. </p>
                <p>J'ai poursuivi avec une formation de 4 mois avec l'organisme <strong>Women in Digital</strong> et l'école <strong>Web Force 3</strong>, formation très intense où l'on a pu découvrir : HTML/ CSS/ JS/ JQuery/ Ajax/ Angular/ PHP/ Symfony/...</p><p>La formation était vraiment complète, mais découvrant tout juste le développement web, je souhaitais consolider ces acquis tout en continuant à apprendre.</p>
                ...
                <p>J'ai été accueilli dans une petite équipe de 3 personnes : 1 chargé de projet, un développeur et un alternant de 2ème année. J'ai travaillé en JS et PHP principalement, sur la création d'outil interne pour automatiser certains process:</p>
                <ul>
            ...
            <article id="integrationEquipe">
                ...
                <div>
                    <h4><FontAwesomeIcon icon={faBullseye} color="#9959f7"/>Qualités</h4>
                ...
                <div>
                    <h4><FontAwesomeIcon icon={faBullseye} color="#9959f7"/>Axes de progression</h4>
                    <div className='about__section__infosContent'>
                    {
                ...
                <div>
                    <h4><FontAwesomeIcon icon={faBullseye} color="#9959f7"/>Ce que j'attends de ma future équipe</h4>
                    <div className='about__section__infosContent'>
                    {
            ...
            <article id="traitspersonnalites">
                ...
                <p>J'adore également cuisiner, je m'essaie au pain maison, crème maison, même si je ne saurais expliquer que parfois tout ce que je cuisine est loupé.</p>
