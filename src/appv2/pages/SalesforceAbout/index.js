        ...
        <section className='page__salesforce-profil-about' id="page__salesforce-profil-about">
            ...
            <article>
                <div className='page__salesforce-profil-about-bluecloud'>
                    ...
                    <p>Après une année d’alternance en tant de développeuse fullstack, je me suis spécialisée dans l’environnement Salesforce en tant que <em>B2C developer</em>.
                    </p>
